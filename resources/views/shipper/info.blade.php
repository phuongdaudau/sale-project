                            ...
                            <div>
                                ...
                                <div class="tab-content">
                                    <div role="tabpanel" class="tab-pane fade active in" id="profile_settings">
                                        <form action="{{ route('shipper.user.update', $user->id) }}" method="POST" enctype="multipart/form-data" class="form-horizontal">
                                            @csrf
                                            @method('PUT')
                                    ...
                                    <div role="tabpanel" class="tab-pane fade" id="change_password_settings">
                                        <form method="POST" action="{{ route('shipper.password.update') }}" class="form-horizontal">
                                            @csrf
                                            @method('PUT')
                                            <div class="form-group">
