                                    ...
                                    @foreach($orders as $key=>$order)
                                        <tr>
                                            ...
                                            <td class ="text-center">
                                                <a href="{{ route('staff.order.show', $order->id)}} " class= "btn btn-success waves-effect">
                                                    <i class ="material-icons">visibility</i>
                                                </a>
                                                <button class= "btn btn-danger waves-effect" type="button" onclick="deleteorder({{ $order->id }})">
                                                    <i class="material-icons">delete</i>
                                                </button>
                                                <form id="delete-form-{{ $order->id }}" action=" {{ route('staff.order.destroy', $order->id)}}" method="POST" style="display: none;">
                                                    @csrf
                                                    @method('DELETE')
                                                </form>
                                            </td>
