...
@section('content')
    <div class="container-fluid">
        ...
        <form action="{{ route('staff.order.update', $order->id) }}" method="POST" enctype="multipart/form-data">
            @csrf
            @method('PUT')
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    ...
                    <a  class="btn btn-danger m-t-15 waves-effect" href="{{ route('staff.order.index') }}">TRỞ LẠI</a>
